...
class ConfettiGenerator {
  ...
  constructor(params) {
    this.target = params.target;
    this.maxCount = window.innerWidth < 600 ? 100 : params.maxCount || 200; // Fewer particles on mobile
    this.size = window.innerWidth < 600 ? 8 : params.size || 12; // Smaller particles on mobile
